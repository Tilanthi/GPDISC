...
class ActiveKnowledgeSystem:
    """
    Coordinates curiosity-driven active knowledge acquisition:
    gap detection, hypothesis generation, and knowledge integration.
    """
    ...
    def detect_gaps(self, *args, **kwargs):
        return self.gap_detector.detect_gaps(*args, **kwargs)

    def generate_hypotheses(self, *args, **kwargs):
        return self.hypothesis_generator.generate_hypotheses(*args, **kwargs)


def create_active_knowledge_system() -> ActiveKnowledgeSystem:
    """Factory for the active knowledge system (factory-pattern convention)."""
