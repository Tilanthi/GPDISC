"""
Integrated Counterfactual Reasoning System for GPDISC

This module integrates counterfactual reasoning capabilities into GPDISC's
...
- Access through standard GPDISC interfaces
...
class IntegratedCounterfactualSystem:
    ...
    def __init__(self):
        ...
        try:
            ...
            try:
                from gpdisc_core.reasoning.counterfactual_reasoning import CounterfactualEngine
            except ImportError:
...
def process_query_with_counterfactual(query: str,
    ...
    It can be called from GPDISC's standard interfaces.
