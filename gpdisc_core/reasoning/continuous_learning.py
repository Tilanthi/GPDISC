...
# Shared default learner singleton
_default_learner: Optional[ContinuousLearner] = None


def get_continuous_learner(storage_path: str = None) -> ContinuousLearner:
    """Return the shared default ContinuousLearner singleton."""
    global _default_learner
    if _default_learner is None:
        _default_learner = ContinuousLearner(storage_path)
