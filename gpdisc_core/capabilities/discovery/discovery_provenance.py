...
- Section 3.5 claimed GPDISC "analyzed Taurus molecular cloud" and discovered
...
class DiscoveryProvenance:
    ...
    # Metadata
    timestamp: str = ""
    analyst: str = "ASTRA"  # Human or GPDISC
...
class DiscoveryProvenanceTracker:
    ...
    Usage:
        ...
        tracker.register_discovery(
            ...
            data_files=["/data/astra_archive/filamentcatalogue.fits"],
    ...
    def __init__(self, registry_path: Optional[Path] = None):
        # Package-relative default: gpdisc_core/capabilities/.discovery_registry.json
...
def register_real_discoveries():
    ...
    tracker.register_discovery(
        ...
        claim="Analyzed Herschel astra_archive/filamentcatalogue.fits data for Cygnus region, "
              "characterizing filament size distribution and stability properties",
        data_files=["docs/astra_archive/filamentcatalogue.fits"],
        analysis_code=["docs/filament_analysis_pipeline.md"],
        result_files=["docs/cygnus_filament_analysis.md"],
    ...
    tracker.register_discovery(
        ...
        result_files=[],
        figure_files=[
            "RASTI/figures_v41/fig_causal_chain.png",
            "RASTI/figures_v41/fig_sfe_correlation.png",
            "RASTI/figures_v41/fig_core_pattern.png"
        ],
