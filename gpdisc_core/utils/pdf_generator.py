...
class ASTRAPDFStyles:
    """Pre-defined styles for GPDISC documents"""
...
class ASTRAPDFGenerator:
    """
    Main PDF generator for GPDISC scientific papers
...
if __name__ == '__main__':
    ...
    print("BIODISC PDF Generator Module")
    print("="*50)
    print("Available classes:")
    print("  - BIODISCPDFGenerator: Main PDF generator (recommended)")
    print("  - PDFGenerator: Alias for BIODISCPDFGenerator (convenience)")
    print("  - ASTRAPDFGenerator: Legacy alias (backward compatibility)")
    print("  - BIODISCPDFStyles: Style management")
    print("  - MarkdownConverter: Markdown to HTML")
    print("  - WrappedTableCell: Table cell wrapping")
    print()
    print("Usage:")
    print("  from gpdisc_core.utils.pdf_generator import PDFGenerator")
    print("  pdf = PDFGenerator('output.pdf')")
    print("  pdf.add_title('My Paper')")
    print("  pdf.add_paragraph('This is **bold** and *italic* text.')")
    print("  pdf.build()")


# Backward compatibility aliases and convenience imports
# These allow the module to work with different import styles

# Primary class name (GPDISC)
...
# Legacy alias (GPDISC - for backward compatibility)
# ASTRAPDFGenerator and ASTRAPDFStyles are already defined as the main classes

# Export list for __all__
__all__ = [
    'PDFGenerator',  # Recommended - short and clear
    'BIODISCPDFGenerator',  # Full GPDISC name
    'ASTRAPDFGenerator',  # Legacy GPDISC name (backward compatibility)
    'PDFStyles',  # Recommended
    'BIODISCPDFStyles',  # Full GPDISC name
    'ASTRAPDFStyles',  # Legacy GPDISC name (backward compatibility)
    'MarkdownConverter',
    'WrappedTableCell',
