    ...
    def _initialize_default_experts(self):
        ...
        experts_config = [
            ...
            Expert(
                ...
                module_path="gpdisc_core.causal.model.scm.StructuralCausalModel",
            ...
            Expert(
                name="pc_algorithm",
                module_path="gpdisc_core.causal.discovery.pc_algorithm.PCAlgorithm",
            ...
            Expert(
                ...
                module_path="gpdisc_core.causal.intervention.planner",
                task_types=[TaskType.CAUSAL_ANALYSIS, TaskType.REASONING],
                specialization_keywords=[
            ...
            Expert(
                ...
                module_path="gpdisc_core.causal.counterfactual.engine",
                task_types=[TaskType.CAUSAL_ANALYSIS, TaskType.REASONING],
                specialization_keywords=[
            ...
            Expert(
                ...
                module_path="gpdisc_core.discovery.engine.DiscoveryEngine",
            ...
            Expert(
                name="data_analyzer",
                module_path="gpdisc_core.discovery.analysis.DataAnalyzer",
            ...
            Expert(
                ...
                module_path="gpdisc_core.memory.episodic.memory.EpisodicMemory",
            ...
            Expert(
                ...
                module_path="gpdisc_core.memory.semantic.memory.SemanticMemory",
            ...
            Expert(
                name="working_memory",
                module_path="gpdisc_core.memory.working.memory.WorkingMemory",
                task_types=[TaskType.MEMORY, TaskType.REASONING],
                specialization_keywords=[
            ...
            Expert(
                name="vector_search",
                module_path="gpdisc_core.memory.vector.store.VectorStore",
            ...
            Expert(
                ...
                module_path="gpdisc_core.metacognitive.monitoring.Monitor",
            ...
            Expert(
                name="goal_manager",
                module_path="gpdisc_core.metacognitive.goals.GoalManager",
            ...
            Expert(
                ...
                module_path="gpdisc_core.simulation.physics.PhysicsSimulator",
            ...
            Expert(
                ...
                module_path="gpdisc_core.simulation.astronomy.AstronomySimulator",
                task_types=[TaskType.SIMULATION, TaskType.ASTRONOMY],
                specialization_keywords=[
            ...
            Expert(
                ...
                module_path="gpdisc_core.simulation.market.MarketSimulator",
            ...
            Expert(
                name="astro_analysis",
                module_path="gpdisc_core.astronomy.analysis.Analyzer",
            ...
            Expert(
                name="analogy_engine",
                module_path="gpdisc_core.creative.analogy.AnalogyEngine",
            ...
            Expert(
                ...
                module_path="gpdisc_core.creative.insight.InsightGenerator",
            ...
            Expert(
                ...
                module_path="gpdisc_core.capabilities.bayesian_inference",
            ...
            Expert(
                name="gpqa_solver",
                module_path="gpdisc_core.capabilities.gpqa_strategies",
...
def create_moe_router(top_k: int = 3, min_score_threshold: float = 0.1) -> MoECapabilityRouter:
    """Factory for the MoE capability router (factory-pattern convention)."""
    return MoECapabilityRouter(top_k=top_k, min_score_threshold=min_score_threshold)


def create_conditional_engine(router=None, top_k: int = 3,
                              min_score_threshold: float = 0.1) -> ConditionalComputationEngine:
    """Factory for the conditional computation engine (factory-pattern convention)."""
    return ConditionalComputationEngine(router=router, top_k=top_k,
                                        min_score_threshold=min_score_threshold)
