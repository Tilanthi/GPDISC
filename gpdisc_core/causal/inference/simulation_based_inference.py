...
class AstrophysicsSimulator(SimulatorInterface):
    ...
    Wraps existing simulators in gpdisc_core.theoretical_physics
    """
...
class MHDSimulator(AstrophysicsSimulator):
    ...
    def __init__(self):
        ...
        def mhd_simulate(params, n_samples):
            ...
            # In practice, would call gpdisc_core.theoretical_physics.MHDSolver
...
class SimulationBasedInferenceEngine:
    ...
    def _connect_existing_simulators(self) -> None:
        """Connect to existing gpdisc_core simulators"""
        try:
            from ...scientific_discovery.theoretical_physics import MHDSolver, RadiationHydrodynamics
