    ...
    def _handle_dosing_query(self, query: str, context: Optional[Dict[str, Any]]) -> DomainQueryResult:
        ...
        return DomainQueryResult(
            ...
            answer=(
                ...
                "- **Lithium**: 0.4-0.8 mmol/L at 12h post-dose (up to 1.0 in acute mania; UK/NICE target — the older 0.6-1.2 range is NOT UK practice)\n"
    ...
    def _handle_polypharmacy_query(self, query: str, context: Optional[Dict[str, Any]]) -> DomainQueryResult:
        ...
        return DomainQueryResult(
            ...
            answer=(
                ...
                "- **Sulfonylureas**: Hypoglycemia risk (glyburide/glibenclamide > glipizide — avoid glibenclamide in older adults)\n"
    ...
    def _handle_contraindications_query(self, query: str, context: Optional[Dict[str, Any]]) -> DomainQueryResult:
        ...
        return DomainQueryResult(
            ...
            answer=(
                ...
                "- **Sulfonamide allergy**: Avoid sulfonamide ANTIBIOTICS; cross-reactivity with sulfonylureas, thiazides and celecoxib is negligible (the old blanket avoidance is a teaching myth)\n"
