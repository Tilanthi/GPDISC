...
_ROWS = [
    ...
    ("pyelonephritis", "NICE NG111", "Urinary tract infection - upper",
     "Cefalexin or consider admission"),
    ("lower urinary tract symptoms", "NICE CG97",
     "Urinary tract infection - lower (men)",
     "Frequency/volume chart; PSA after counselling"),
    ("acne", "NICE NG198", "Acne vulgaris",
     "Fixed-combination topical retinoid + BPO first; 3 months "
     "before judging failure"),
