...
# Biology MORK Extensions (GPDISC V1.0)
try:
    from .biology_mork_extensions import (
        BiologyMORKExtension,
        create_biology_mork_extension
    )
    _BIOLOGY_MORK_AVAILABLE = True
except ImportError:
    _BIOLOGY_MORK_AVAILABLE = False
    BiologyMORKExtension = None
    create_biology_mork_extension = None
...
# Add biology MORK extensions if available
if _BIOLOGY_MORK_AVAILABLE:
    __all__.extend([
        "BiologyMORKExtension",
        "create_biology_mork_extension",
    ])
