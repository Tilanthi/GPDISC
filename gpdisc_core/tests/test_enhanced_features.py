...
def test_enhanced_features():
    ...
    from gpdisc_core.self_teaching.embedding_novelty import (
    ...
    from gpdisc_core.self_teaching.scientific_data import (
        PhysicsDataLibrary,
    ...
    from gpdisc_core.self_teaching.multi_agent_swarm import (
    ...
    # Agent breakdown
    from gpdisc_core.self_teaching.multi_agent_swarm import AgentRole
    agent_counts = {}
    ...
    from gpdisc_core.self_teaching.arxiv_integration import (
