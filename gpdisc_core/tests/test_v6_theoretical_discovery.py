...
from gpdisc_core.theoretical_discovery import (
...
def test_integration_with_astra_core():
    """Test integration with main gpdisc_core system"""
    print("\n[Integration with STAN Core]")

    try:
        from gpdisc_core import V6TheoreticalDiscovery, create_v6_theoretical_system
        print("  ✓ V6.0 components exported from gpdisc_core")
